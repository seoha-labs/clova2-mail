...
**clova2Mail** is a powerful Chrome Extension that seamlessly integrates with [ClovaNote](https://clovanote.naver.com/) to automatically summarize your meeting minutes using AI (OpenAI) and instantly email the summary to your designated recipients via Gmail.
...
- **Direct Gmail Sending**: Securely connects to your Gmail account via OAuth2 to send the summarized meeting notes without leaving the page.
...
- **Privacy-First API Key Mgt**: Your OpenAI API key is stored securely in your local browser storage—no intermediate backends.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/clova2Mail.git
   cd clova2Mail
   ```
